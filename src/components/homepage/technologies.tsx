            ...
            <div className="flex flex-row flex-wrap items-center justify-center gap-[16px] container">
                {badges.map((b) => (
                    <MotionBadge
                        ...
                        whileHover={{ 
                            scale: 1.08,
                            boxShadow: "0 0 20px rgba(196, 184, 168, 0.4), 0 4px 16px rgba(0,0,0,0.1)"
                        }}
                        whileTap={{ scale: 0.96 }}
                        transition={{ type: "spring", stiffness: 300, damping: 20 }}
                        className="rounded-xl border-2 border-transparent hover:border-bone-warm/50 hover:bg-bone-warm/5 transition-all duration-300"
                        >
